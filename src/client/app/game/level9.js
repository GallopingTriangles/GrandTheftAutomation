...
var createGame = (userInput) => {
  ...
  var FAKE_USER_INPUT = {
    ...
    speed: 100,
    sensor: true,
    case: 1 // success: [LEFT, RIGHT, RIGHT, LEFT]
    // case: 2 // fail: [LEFT, RIGHT, RIGHT, STRAIGHT, STRAIGHT]
    // case: 3 // fail: [LEFT, RIGHT, RIGHT, STRAIGHT, RIGHT]
    // case: 4 // fail: [LEFT, RIGHT, RIGHT, RIGHT]
  }
  /**********************************************************/
  /**********************************************************/
